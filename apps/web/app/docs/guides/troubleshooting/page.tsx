const TroubleshootingGuidePage = () => (
  <div className="p-8 max-w-3xl">
    <h1 className="text-3xl font-semibold text-neutral-600 dark:text-neutral-300 mb-4">Troubleshooting Guide</h1>
    <ul className="list-disc list-inside text-neutral-500 dark:text-neutral-400 mb-4 space-y-2">
      ...
      <li><b>Database connection issues?</b> Double-check your <code className="bg-neutral-200 dark:bg-neutral-800 px-2 py-1 rounded">DATABASE_URL</code> and network access.</li>
